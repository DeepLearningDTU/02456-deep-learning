...
![Building image]('https://github.com/DeepLearningDTU/02456-deep-learning/blob/master/files/build_docker.png?raw=true')
...
![Running image]('https://github.com/DeepLearningDTU/02456-deep-learning/blob/master/files/run_docker.png?raw=true')
