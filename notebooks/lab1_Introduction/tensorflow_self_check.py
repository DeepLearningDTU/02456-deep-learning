# From: https://gist.github.com/mrry/ee5dbcfdd045fa48a27d56664411d41c
#
...
- Could not load 'cudnn64_5.dll'. The GPU version of TensorFlow
  ...
  * TensorFlow 1.3 or later requires cuDNN 6. ('cudnn64_6.dll')
  ...
  if not candidate_explanation:
    print("""
- All required DLLs appear to be present. If an error persists please open an issue on the
